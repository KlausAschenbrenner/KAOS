...
// Maps the whole VESA Frame Buffer to the Virtual Base Address 0xFFFF8000E8000000
void MapFrameBuffer()
{
	long virtualAddress = WINDOW_FRAME_BUFFER;
	long physicalAddress = WINDOW_FRAME_BUFFER_PHYSICAL;
	int i;
