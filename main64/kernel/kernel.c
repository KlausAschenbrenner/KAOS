...
{
	int cntr = 0;
	Window *window = NewDesktopWindow(desktop, 50, 50, 400, 720, "Window Title 1\0");
...
{
	int cntr = 0;
	Window *window = NewDesktopWindow(desktop, 200, 200, 400, 720, "Window Title 2\0");
	window->Task = (Task *)GetTaskState();
...
{
	int cntr = 0;
	Window *window = NewDesktopWindow(desktop, 300, 300, 400, 720, "Window Title 3\0");
	window->Task = (Task *)GetTaskState();
...
void CreateTasksVGA()
{
	CreateUserTask(DesktopWindow1, 1, 0xFFFF800001100000, 0xFFFF800000010000);
	CreateUserTask(DesktopWindow2, 2, 0xFFFF800001200000, 0xFFFF800000020000);
	CreateUserTask(DesktopWindow3, 3, 0xFFFF800001300000, 0xFFFF800000030000);
	/* CreateKernelTask(DesktopWindow1, 1, 0xFFFF800001100000);
	CreateKernelTask(DesktopWindow2, 2, 0xFFFF800001200000);
	CreateKernelTask(DesktopWindow3, 3, 0xFFFF800001300000); */
	CreateKernelTask(MouseHandler, 4, 0xFFFF800001400000);
}
